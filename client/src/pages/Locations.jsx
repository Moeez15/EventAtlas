...
const Locations = () => {
    ...
    return (
        <div className='available-locations'>
            <Link id='venue1button' className='venue1-button-overlay' to='/echolounge'>
                <button>{venueNames.venue1}</button>
            </Link>

            <Link id='venue2button' className='venue2-button-overlay' to='/houseofblues'>
                <button>{venueNames.venue2}</button>
            </Link>

            <Link id='venue3button' className='venue3-button-overlay' to='/pavilion'>
                <button>{venueNames.venue3}</button>
            </Link>

            <Link id='venue4button' className='venue4-button-overlay' to='/americanairlines'>
